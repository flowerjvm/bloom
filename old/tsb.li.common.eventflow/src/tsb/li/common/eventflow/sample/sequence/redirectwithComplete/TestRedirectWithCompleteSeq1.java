...
public class TestRedirectWithCompleteSeq1 extends SeqBase {
    
    public TestRedirectWithCompleteSeq1() {
    ...
    protected void action(int seqNo) {
        ...
        case 0:
        	{
        		System.out.println("TestRedirectWithCompleteSeq1 Start!");
        		super.setNextSeq(10);
    			super.startTick();
        	}
        	break;
        ...
        case 10:
        	{
        		if (super.getElapsedTicks() > 5000) {
        			System.out.println("TestRedirectWithCompleteSeq1 Redirect to <3>!");
        			
        			super.setNextSeq(TestRedirectWithCompleteSeq3.class, true);
        			
        			System.out.println("TestRedirectWithCompleteSeq1 is Completed!");
    			}
        	}
        	break;
        }
