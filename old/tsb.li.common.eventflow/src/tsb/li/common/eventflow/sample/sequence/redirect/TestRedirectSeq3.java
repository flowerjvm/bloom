...
public class TestRedirectSeq3 extends SeqBase {
    
    public TestRedirectSeq3() {
    ...
    protected void action(int seqNo) {
    	...
    	case 0:
			{
				System.out.println("TestRedirectSeq3 Start!");
				super.setNextSeq(10);
				super.startTick();
			}
			break;
    	...
    	case 10:
			{
				if (super.getElapsedTicks() > 5000) {
					System.out.println("TestRedirectSeq3 Redirect to <2>!");
					super.setNextSeq(TestRedirectSeq2.class);
				}
			}
			break;
        }
