...
public class TestRedirectSeq2 extends SeqBase {
    
    public TestRedirectSeq2() {
    ...
    protected void action(int seqNo) {
    	...
    	case 0:
    		{
    			System.out.println("TestRedirectSeq2 Start!");
    			super.setNextSeq(10);
    			super.startTick();
    		}
    		break;
    	...
    	case 10:
    		{
    			if (super.getElapsedTicks() > 5000) {
    				System.out.println("TestRedirectSeq2 Redirect to <4>!");
    				super.setNextSeq(TestRedirectSeq4.class);
    			}
    		}
    		break;
    	}
